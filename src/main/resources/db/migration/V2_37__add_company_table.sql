...
ALTER TABLE structures ADD COLUMN company_id INT NULL;

ALTER TABLE etags ADD COLUMN company_id INT NULL;
...
UPDATE structures SET company_id = alta_vista_id WHERE company_id IS NULL;
UPDATE etags SET company_id = alta_vista_id WHERE company_id IS NULL;
END $$;
